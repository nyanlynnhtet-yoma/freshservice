...
AccountURI = "https://yomabankservicedesk.freshservice.com"
ProbeKey = ""
RegistrationKey="eyJ0eXAiOiJKV1QiLCJhbGciOiJIUzI1NiJ9.eyJwb3J0YWxfdXJsIjoiaHR0cHM6Ly95b21hYmFua3NlcnZpY2VkZXNrLmZyZXNoc2VydmljZS5jb20ifQ.FLU_fJvVyDq2Osvf3mVuuo42Crm0Fq6gSuP0JfuVFlM"
ProxyServer = ""
ProxyUserName = ""
ProxyPassword = ""
ProxyPort = ""
...
execute_shell_command_ex_handled('/bin/bash "{0}"'.format(os.path.join(curr_dir, "Freshservice-Discovery-Agent", "setup.sh")))
try:
    import shutil
